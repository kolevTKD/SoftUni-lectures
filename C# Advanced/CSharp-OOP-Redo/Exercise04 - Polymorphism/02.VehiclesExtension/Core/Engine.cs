    ...
    public class Engine : IEngine
    {
        ...
        public void Run()
        {
            ...
            for (int i = 0; i < lines; i++)
            {
                ...
                catch (FuelMustBePositiveException fmbp)
                {
                    writer.WriteLine(fmbp.Message);
                }
                catch (InsufficientFuelAmountException ifa)
                {
        ...
        private IVehicle CreateVehicleViaFactory()
        {
            ...
            IVehicle vehicle = vehicleFactory.CreateVehicle(type, fuelQuantity, fuelConsumptionLKm, tankCapacity);
        ...
        private void ProcessCommand()
        {
            ...
            if (vehicleToProcess != null)
            {
                ...
                else if (cmd == "DriveEmpty")
                {
                    ...
                    writer.WriteLine(bus.DriveEmpty(arg));
                }
            }
            else
            {
