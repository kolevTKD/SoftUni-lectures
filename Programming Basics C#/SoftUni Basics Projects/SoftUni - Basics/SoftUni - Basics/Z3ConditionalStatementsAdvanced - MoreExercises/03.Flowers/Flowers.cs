...
namespace _03.Flowers
{
    class Flowers
    {
        static void Main(string[] args)
        {
            ...
            double rosePrice = 0;
            double tulipPrice = 0;
            double totalForChrysnthemums = 0;
            double totalForRoses = 0;
            double totalForTulips = 0;
            ...
            totalForChrysnthemums = chrysanthemumsBought * chrysanthemumPrice;
            totalForRoses = rosesBought * rosePrice;
            totalForTulips = tulipsBought * tulipPrice;
            bouquetPrice = totalForChrysnthemums + totalForRoses + totalForTulips;
